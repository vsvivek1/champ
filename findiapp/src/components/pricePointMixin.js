...
params.arryOfInstruments=arryOfInstruments;
        ...
        getPricePoints(inst_token=this.instrument_tocken,acces_token=this.accessToken){
...
console.log('yesterday',this.yesterday)
        ...
        if(typeof(this.yesterday)=='undefined'){
            ...
            let pricePointAbove5pcYesterdayHigh= this.prices.filter(p=>p.high>yesterdayHigh5pc);
