...
<!-- {{ orders }}  -->
   <!-- <div fluid> -->
      <v-row>
        ...
        <v-col>
          <button @click = "updateSelectedSellorderWithLtp(  )">Update Sell orders with LTP </button>
        </v-col>   <v-col>
          <button  color = "cyan" @click = "updateSelectedBuyorderWithAvg(  )">Update BUY orders with AVG </button>
        </v-col>
        ...
        <button @click = "reclaimSoldStocks(  )">reclaimSoldStocks</button>
          <button @click = "SellHoldingsWithCondition(  )">Sell Holdings  with Condition</button>
        </v-col>
         <v-col>  <button @click = "getLTP(  )" color = "cyan">Retry Buy Orders with LTPS <span>mdi-rotate-left </span>
      </button>
         </v-col>
         <v-col>

<button @click = "StartTimer(  )">Start Timer {{ timeInSecondsToTargetTime }}  </button>
    ...
    <v-col>  <button  @click = "cancelSelectedOrders(  )" color = "red">CAncel Selected Order
      <span> mdi-close-circle-multiple-outline</span>
    </button>
    </v-col>
      </v-row>
