import {  socket, instruments, instrumentsAll  }  from './Tester.vue';
...
let a  =  ( element.last_price >=  cis.pricePoints.d1.high /// break todays high at reference time
...
async generateSignalsForTester( s ) { 
