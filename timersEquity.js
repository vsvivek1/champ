...
const instrumentsStocks = require('./appv3/public/instruments/instrumentsStocks.json');
  ...
  async   fetchHourlyData() {
    ...
    return new Promise(async (res,rej)=>{
        ...
        console.log('timer for hourly lows')
         let instruments = require('./appv3/public/instruments/instrumentsStocks.json')
        //  let instruments = require('./appv3/public/instruments/instrumentsForCommodity.json')

       
        let symbols = instruments.filter(ix=>ix.instrument_type=="EQ").
